...
const Navbar = () => {
  return (
    ...
    <nav className='py-3 px-2 bg-primary-light dark:bg-primary '>
        <ul className='flex gap-5  max-w-6xl mx-auto'>
            {menu.map((item, index) => (
                <li key={index} className='text-sm hover:text-secondary transition ease-in'>
