...
const CarCard = (params) => {
  return (
    <div className="dark:bg-primary h-40 px-2  flex rounded-xl dark:text-white text-nowrap hover:text-wrap">
      ...
      <div className='w-1/4 flex-shrink-0 flex-grow-0 flex flex-col justify-between p-2'>
          <div>
            ...
            <div className=""></div>
            <button className="btn block text-white w-full my-1 bg-primary">Seller Phone</button>
